...
frontier-template-node.exe --chain teranyina.json --validator --rpc-port 8334 --port 30333 --ws-port 9944 --node-key="%nodeK%" --rpc-methods=Unsafe --rpc-external --rpc-cors=all --ws-external --name teranyina --bootnodes /ip4/84.88.144.253/tcp/21000/p2p/12D3KooWL4orhdQao3iErVSGgruU9XkiwWKVZzjJutn1wKg44aAt